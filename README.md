...
<div align="center">
  <img src="public/current-map.png" alt="Protein Neighborhoods logo"/>
</div>
...
Most of the preprocessing was done in a (somewhat bloated) [Google Colab notebook](https://colab.research.google.com/drive/1AchN-_R6ZLQmKgMV8Dmxrncx7a5dXGKF?usp=sharing). In that notebook, I:

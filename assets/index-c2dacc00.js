import{b as ye,g as me}from"./config-08cc2f6c.js";import{n as be}from"./getColorTheme-3ad3fafe.js";function xe(t,e){for(var a=0;a<e.length;a++){const s=e[a];if(typeof s!="string"&&!Array.isArray(s)){for(const d in s)if(d!=="default"&&!(d in t)){const u=Object.getOwnPropertyDescriptor(s,d);u&&Object.defineProperty(t,d,u.get?u:{enumerable:!0,get:()=>s[d]})}}}return Object.freeze(Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}))}var R={exports:{}},T={exports:{}},Z=function(e){return e===0?"x":e===1?"y":e===2?"z":"c"+(e+1)};const we=Z;var P=function(e){return a;function a(s,d){let u=d&&d.indent||0,l=d&&d.join!==void 0?d.join:`
`,v=Array(u+1).join(" "),r=[];for(let f=0;f<e;++f){let c=we(f),b=f===0?"":v;r.push(b+s.replace(/{var}/g,c))}return r.join(l)}};const ee=P;T.exports=Be;T.exports.generateCreateBodyFunctionBody=te;T.exports.getVectorCode=re;T.exports.getBodyCode=ne;function Be(t,e){let a=te(t,e),{Body:s}=new Function(a)();return s}function te(t,e){return`
${re(t,e)}
${ne(t)}
return {Body: Body, Vector: Vector};
`}function ne(t){let e=ee(t),a=e("{var}",{join:", "});return`
function Body(${a}) {
  this.isPinned = false;
...
};`}function re(t,e){let a=ee(t),s="";return e&&(s=`${a(`
   var v{var};
Object.defineProperty(this, '{var}', {
  ...
  Vector.prototype.reset = function () {
    ${a("this.{var} = ",{join:""})}0;
  };`}var $e=T.exports,C={exports:{}};const W=P,$=Z;C.exports=Ce;C.exports.generateQuadTreeFunctionBody=oe;C.exports.getInsertStackCode=ue;C.exports.getQuadNodeCode=se;C.exports.isSamePosition=ie;C.exports.getChildBodyCode=de;C.exports.setChildBodyCode=ae;function Ce(t){let e=oe(t);return new Function(e)()}function oe(t){let e=W(t),a=Math.pow(2,t);return`
${ue()}
${se(t)}
${ie(t)}
${de(t)}
...
`}var Fe=C.exports,G={exports:{}};G.exports=Se;G.exports.generateFunctionBody=fe;const _e=P;function Se(t){let e=fe(t);return new Function("bodies","settings","random",e)}function fe(t){let e=_e(t);return`
  var boundingBox = {
...
`}var qe=G.exports,U={exports:{}};const Ie=P;U.exports=Pe;U.exports.generateCreateDragForceFunctionBody=ce;function Pe(t){let e=ce(t);return new Function("options",e)}function ce(t){return`
  if (!Number.isFinite(options.dragCoefficient)) throw new Error('dragCoefficient is not a finite number');

  return {
    update: function(body) {
      ${Ie(t)("body.force.{var} -= options.dragCoefficient * body.velocity.{var};",{indent:6})}
    }
  };
`}var Ne=U.exports,z={exports:{}};const Me=P;z.exports=Ee;z.exports.generateCreateSpringForceFunctionBody=ve;function Ee(t){let e=ve(t);return new Function("options","random",e)}function ve(t){let e=Me(t);return`
...
`}var je=z.exports,J={exports:{}};const Te=P;J.exports=Le;J.exports.generateIntegratorFunctionBody=pe;function Le(t){let e=pe(t);return new Function("bodies","timeStep","adaptiveTimeStepWeight",e)}function pe(t){let e=Te(t);return`
